...
use crate::{ReaderError, Status, Transaction, TransactionReader, TxType};
...
mod tests {
    ...
    use crate::{FieldName, ParseError, Status, Transaction, TxType, error::ValidationError};
    ...
    fn test_bin_reader_validates() {
        let data = vec![
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x00, //TX_TYPE: Deposit
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //FROM_USER_ID: 0
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //TO_USER_ID: 0
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Depostit 0 0
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x00, //TX_TYPE: Deposit
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //FROM_USER_ID: 0
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Depostit 0 100
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x00, //TX_TYPE: Deposit
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Depostit 100 0
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x00, //TX_TYPE: Deposit
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, //FROM_USER_ID: 100
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Depostit 100 200
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x01, //TX_TYPE: Transfer
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //FROM_USER_ID: 0
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Transfer 0 0
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x01, //TX_TYPE: Transfer 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //FROM_USER_ID: 0
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Transfer 0 100
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x01, //TX_TYPE: Transfer
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, //FROM_USER_ID: 100
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Transfer 100 0
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x01, //TX_TYPE: Transfer
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, //FROM_USER_ID: 100
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Transfer 100 200
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x02, //TX_TYPE: Withdrawal
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //FROM_USER_ID: 0
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Withdraw 0 0
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x02, //TX_TYPE: Withdrawal
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //FROM_USER_ID: 0
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Withdraw 0 100
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x02, //TX_TYPE: Withdrawal
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, //FROM_USER_ID: 100
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00, //Withdraw 100 0
            0x59, 0x50, 0x42, 0x4E, 0x00, 0x00, 0x00, 0x2E, 
            0x00, 0x03, 0x8D, 0x7E, 0xA4, 0xC6, 0x80, 0x00, 
            0x02, //TX_TYPE: Withdrawal
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, //FROM_USER_ID: 100
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 
            0x00, 0x00, 0x01, 0x7C, 0x38, 0x94, 0xFA, 0x60, 
            0x00, 0x00, 0x00, 0x00, 0x00 //Withdraw 100 200
        ];
